...
from quantworks import stratanalyzer
...
class Returns(stratanalyzer.StrategyAnalyzer):
    """
    A :class:`quantworks.stratanalyzer.StrategyAnalyzer` that calculates time-weighted returns for the
    whole portfolio.
    ...
    def getReturns(self):
        """Returns a :class:`quantworks.dataseries.DataSeries` with the returns for each bar."""
        return self.__netReturns

    def getCumulativeReturns(self):
        """Returns a :class:`quantworks.dataseries.DataSeries` with the cumulative returns for each bar."""
