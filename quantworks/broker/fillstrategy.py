...
class FillStrategy(object):
    ...
    def fillMarketOrder(self, broker_, order, bar):
        ...
        :type order: :class:`quantworks.broker.MarketOrder`
        :param bar: The current bar.
        :type bar: :class:`quantworks.bar.Bar`
    ...
    def fillLimitOrder(self, broker_, order, bar):
        ...
        :type broker_: :class:`Broker`
        :param order: The order.
        :type order: :class:`quantworks.broker.LimitOrder`
        :param bar: The current bar.
        :type bar: :class:`quantworks.bar.Bar`
        :rtype: A :class:`FillInfo` or None if the order should not be filled.
        """
    ...
    def fillStopOrder(self, broker_, order, bar):
        ...
        :type broker_: :class:`Broker`
        :param order: The order.
        :type order: :class:`quantworks.broker.StopOrder`
        :param bar: The current bar.
        :type bar: :class:`quantworks.bar.Bar`
        :rtype: A :class:`FillInfo` or None if the order should not be filled.
        """
    ...
    def fillStopLimitOrder(self, broker_, order, bar):
        ...
        :type broker_: :class:`Broker`
        :param order: The order.
        :type order: :class:`quantworks.broker.StopLimitOrder`
        :param bar: The current bar.
        :type bar: :class:`quantworks.bar.Bar`
        :rtype: A :class:`FillInfo` or None if the order should not be filled.
        """
...
class DefaultStrategy(FillStrategy):
    ...
    * A :class:`quantworks.broker.MarketOrder` is always filled using the open/close price.
    * A :class:`quantworks.broker.LimitOrder` will be filled like this:
    ...
    * A :class:`quantworks.broker.StopOrder` will be filled like this:
    ...
    * A :class:`quantworks.broker.StopLimitOrder` will be filled like this:
    ...
    .. note::
        ...
        * It uses :class:`quantworks.broker.slippage.NoSlippage` slippage model by default.
    ...
    def setSlippageModel(self, slippageModel):
        ...
        :type slippageModel: :class:`quantworks.broker.slippage.SlippageModel`
        """
