...
class BaseBarFeed(feed.BaseFeed):
    ...
    def getLastBar(self, instrument):
        """Returns the last :class:`quantworks.bar.Bar` for a given instrument, or None."""
    ...
    def getDataSeries(self, instrument=None):
        """Returns the :class:`quantworks.dataseries.bards.BarDataSeries` for a given instrument.

        :param instrument: Instrument identifier. If None, the default instrument is returned.
        :type instrument: string.
        :rtype: :class:`quantworks.dataseries.bards.BarDataSeries`.
        """
