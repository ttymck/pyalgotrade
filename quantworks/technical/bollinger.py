...
class BollingerBands(object):
    ...
    def getUpperBand(self):
        """
        Returns the upper band as a :class:`quantworks.dataseries.DataSeries`.
        """
        return self.__upperBand

    def getMiddleBand(self):
        """
        Returns the middle band as a :class:`quantworks.dataseries.DataSeries`.
        """
        return self.__sma

    def getLowerBand(self):
        """
        Returns the lower band as a :class:`quantworks.dataseries.DataSeries`.
        """
