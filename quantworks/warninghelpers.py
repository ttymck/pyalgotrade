...
class QuantWorksDeprecationWarning(DeprecationWarning):
    pass

warnings.simplefilter("default", QuantWorksDeprecationWarning)
...
def deprecation_warning(msg, stacklevel=0):
    warnings.warn(msg, category=QuantWorksDeprecationWarning, stacklevel=stacklevel+1)
