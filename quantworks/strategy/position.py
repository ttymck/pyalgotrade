...
from quantworks import warninghelpers
...
class Position(object):
    ...
    :type strategy: :class:`quantworks.strategy.BaseStrategy`.
    :param entryOrder: The order used to enter the position.
    :type entryOrder: :class:`quantworks.broker.Order`
    ...
    def getEntryOrder(self):
        """Returns the :class:`quantworks.broker.Order` used to enter the position."""
        return self.__entryOrder

    def getExitOrder(self):
        """Returns the :class:`quantworks.broker.Order` used to exit the position. If this position hasn't been closed yet, None is returned."""
