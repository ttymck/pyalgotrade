...
class FreeFunctionsTestCase(BaseTestCase):
    def testStopOrderTriggerBuy(self):
        barsBuilder = broker_backtesting_test.BarsBuilder(BaseTestCase.TestInstrument, bar.Interval.MINUTE)
        # Bar is below
...
class DefaultStrategyTestCase(BaseTestCase):
    def setUp(self):
        ...
        self.barsBuilder = broker_backtesting_test.BarsBuilder(BaseTestCase.TestInstrument, bar.Interval.MINUTE)
